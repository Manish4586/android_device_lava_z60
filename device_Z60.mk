...
$(call inherit-product-if-exists, vendor/Lava/Z60/Z60-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/Lava/Z60/overlay
PRODUCT_PACKAGE_OVERLAYS += device/Lava/Z60/overlay # enable this to be able overlay a default wallpaper

LOCAL_PATH := device/Lava/Z60
